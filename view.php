...
<span class="dropdown">
  ...
  <ul class="dropdown-menu" aria-labelledby="datacolumn">
    ...
    <li><a href="?sort=time_scraped">Last Update</a></li>
  </ul>
</span>
</li>
<li>
...
<tr>
  ...
  <th class="info">Course Length</th>
...
$sql = "SELECT DISTINCT *  FROM course_data LEFT JOIN coursedetails ON course_data.id=coursedetails.course_id GROUP BY title ORDER BY course_data.$sort $scend LIMIT $start_from, $courses_per_page";
...
<tr>
  ...
  <td><?php echo ($row['start_date'] != NULL) ? $row['start_date'] : $blank; ?></td>
  <td><?php echo ($row['course_length'] != 0) ? $row['course_fee'] : $selfpaced; ?></td>
...
<tr>
  ...
  <td class="success">#<?php echo ($row['id'] != NULL) ? $row['id'] : $blank; ?></td>
</tr>
<tr>
...
<tr>
  ...
  <td class="success"><?php echo ($row['video_link'] != NULL) ? $row['video_link'] : $blank; ?></td>
</tr>
<tr>
  <td class="success">Start Date: </td>
  <td class="success"><?php echo ($row['start_date'] != NULL) ? $row['start_date'] : $blank; ?></td>
</tr>
<tr>
  <td class="success">Course Length: </td>
...
<tr>
  <td class="success">Last Update: </td>
...
$sql = "SELECT DISTINCT *  FROM course_data LEFT JOIN coursedetails ON course_data.id=coursedetails.course_id GROUP BY title";
